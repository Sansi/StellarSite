...
* 打开Stellar Wi-Fi 应用，点击注册账号按钮。（账号名不能超过）

![login](./images/login.PNG)

* 输入正确有效邮箱和任意有效登录密码，点击提交按钮将自动登录到APP主页。

![login](./images/register.PNG)

## 2. 账号管理

* 点击侧边栏中的头像图标进入用户信息界面，你可以修改你的头像和昵称。

![login](./images/leftMenu.PNG)
![login](./images/leftInfo.PNG)

* 点击侧边栏中的***设置***按钮进入设置界面，你可以退出登录、修改密码或者进入关于我们界面。
...
5. 首次加入目标WiFi需要手动输入WiFi名称和密码，点击加入按钮。此过程需要大约30s。
